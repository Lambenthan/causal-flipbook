...
<div align="center">
  <img src="../assets/chap07/01_parametric_ceiling.gif" alt="参数模型的天花板：函数形式被锁死" width="720" />
</div>
...
<div align="center">
  <img src="../assets/chap07/02_super_learner_weights.gif" alt="Super Learner：把多个算法加权融合" width="720" />
</div>
...
<div align="center">
  <img src="../assets/chap07/03_dml_cross_fitting.gif" alt="DML 5 折交叉拟合" width="720" />
</div>
...
<div align="center">
  <img src="../assets/chap07/04_tmle_targeting_step.gif" alt="TMLE：用一步 epsilon 把初始 Q 推到目标方向" width="720" />
</div>
...
<div align="center">
  <img src="../assets/chap07/05_methods_convergence.gif" alt="9 种方法的点估计与 95% CI" width="720" />
</div>
...
| 第 5 章 · PSM | RD = 0.0621 | [0.0304, 0.0906] | 可交换性 + 正值性 + 处理模型正确 | 丢弃 32.7% 样本，目标人群变成匹配人群 |
